...
class getPrestaSitemap_DumperService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['presta_sitemap.dumper'] = $instance = new \Presta\SitemapBundle\Service\Dumper(($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()), ($container->services['.container.private.filesystem'] ?? ($container->services['.container.private.filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), 'sitemap', 50000, ($container->services['router'] ?? $container->getRouterService()));
