...
class __TwigTemplate_b1b0cf804dc11e023d95376208711600 extends Template
{
    private $source;
    private $macros = [];
    ...
    {% for trackedCode in trackedCodes %}
        {{ trackedCode | raw }}
    {% endfor %}
</script>", "@PimcoreCore/Analytics/Tracking/GoogleTagManager/dataLayer.html.twig", "/var/www/html/pimcore/ecommerce/vendor/pimcore/pimcore/bundles/CoreBundle/Resources/views/Analytics/Tracking/GoogleTagManager/dataLayer.html.twig");
    }
