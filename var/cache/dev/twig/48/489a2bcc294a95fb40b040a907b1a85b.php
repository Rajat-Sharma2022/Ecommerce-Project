            ...
            echo " \" alt=\"tv1\" class=\"bd-placeholder-img card-img-top\" width=\"100%\" height=\"225px\">
                                <p class=\"card-text\">
                                    <h2>
                                        ";
            // line 63
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getDescription", [], "method", false, false, true, 63), 63, $this->source), "html", null, true);
            echo "</h2>
...
";
    ...
    {
        return array (  142 => 79,  124 => 67,  117 => 63,  111 => 60,  106 => 57,  102 => 56,  45 => 1,);
    }
