...
class __TwigTemplate_45db1823db4c0a0128759d8d2fb35247 extends Template
{
    private $source;
    private $macros = [];
...
<nav class=\"navbar navbar-expand-lg bg-body-tertiary\">
  <div class=\"container-fluid\">
    ...
    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
      ...
      </ul><form class=\"d-flex\" role=\"search\" action=\"";
        // line 33
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("searchclothes");
        echo "\" method=\"POST\">
...
    
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["objects"]) || array_key_exists("objects", $context) ? $context["objects"] : (function () { throw new RuntimeError('Variable "objects" does not exist.', 61, $this->source); })()));
            ...
            echo "                    <div class=\"col\">
                        <div class=\"card shadow-sm\">
                            <div class=\"card-body\">
                                <img src=\"";
            // line 65
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getPhoto", [], "method", false, false, true, 65), 65, $this->source), "html", null, true);
            echo " \" alt=\"tv1\" class=\"bd-placeholder-img card-img-top\" width=\"100%\" height=\"225px\">
                                <p class=\"card-text\">

                                            ";
            // line 68
            if ((twig_get_attribute($this->env, $this->source, $context["object"], "getGender", [], "method", false, false, true, 68) == "M")) {
                // line 69
                echo "                                    <h2>Brand:";
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["object"], "getCategory", [], "method", false, false, true, 69), "getMensWear", [], "method", false, false, true, 69), "getBrand", [], "method", false, false, true, 69), 69, $this->source), "html", null, true);
                echo "<h2>
                                    <h2>Size:";
                // line 70
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["object"], "getCategory", [], "method", false, false, true, 70), "getMensWear", [], "method", false, false, true, 70), "getSize", [], "method", false, false, true, 70), 70, $this->source), "html", null, true);
                echo "<h2>
                                            ";
            } else {
                // line 72
                echo "                                               <h2>Brand:";
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["object"], "getCategory", [], "method", false, false, true, 72), "getWomensWear", [], "method", false, false, true, 72), "getBrand", [], "method", false, false, true, 72), 72, $this->source), "html", null, true);
                echo "<h2>
                                               <h2>Size:";
                // line 73
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["object"], "getCategory", [], "method", false, false, true, 73), "getWomensWear", [], "method", false, false, true, 73), "getSize", [], "method", false, false, true, 73), 73, $this->source), "html", null, true);
                echo "<h2>
                                            ";
            }
            // line 75
...
";
    ...
    {
        return array (  178 => 95,  158 => 81,  153 => 79,  147 => 75,  142 => 73,  137 => 72,  132 => 70,  127 => 69,  125 => 68,  119 => 65,  114 => 62,  110 => 61,  79 => 33,  45 => 1,);
    }
...
<nav class=\"navbar navbar-expand-lg bg-body-tertiary\">
  <div class=\"container-fluid\">
    ...
    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
      ...
      </ul><form class=\"d-flex\" role=\"search\" action=\"{{ path('searchclothes') }}\" method=\"POST\">
        <input class=\"form-control me-2\"  name=\"search\" type=\"search\" placeholder=\"Search\" aria-label=\"Search\">
        <button class=\"btn btn-outline-success\" type=\"submit\">Search</button>
      </form>
    </div>
...
", "default/ClothesContent.html.twig", "/var/www/html/Eproject/ecomwebsite/templates/default/ClothesContent.html.twig");
    ...
    {
        static $tags = array("for" => 61, "if" => 68);
