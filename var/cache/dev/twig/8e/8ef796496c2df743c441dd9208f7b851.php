...
class __TwigTemplate_cc121ebd5d2bf6e2771229dd46879e1f extends Template
{
    private $source;
    private $macros = [];
...
<!-- code for footwear-->
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["object"]) {
            ...
            echo "</h2>
                                        ...
                                        ";
            // line 82
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getBrand", [], "method", false, false, true, 82), 82, $this->source), "html", null, true);
            echo "</h2>
...
";
    ...
    {
        return array (  171 => 99,  151 => 85,  145 => 82,  139 => 79,  133 => 76,  124 => 70,  117 => 65,  113 => 64,  79 => 33,  45 => 1,);
    }
...
<nav class=\"navbar navbar-expand-lg bg-body-tertiary\">
  <div class=\"container-fluid\">
    ...
    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
      ...
      <form class=\"d-flex\" role=\"search\" action=\"{{ path('search') }}\" method=\"POST\">
        <input class=\"form-control me-2\"  name=\"search\" type=\"search\" placeholder=\"Search\" aria-label=\"Search\">
        <button class=\"btn btn-outline-success\" type=\"submit\">Search</button>
      </form>
    </div>
