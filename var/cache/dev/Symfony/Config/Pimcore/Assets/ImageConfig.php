...
class ImageConfig 
{
     ...
     * @return $this
     */
    public function maxPixels($value): self
    {
    ...
    public function focalPointDetection(array $value = []): \Symfony\Config\Pimcore\Assets\Image\FocalPointDetectionConfig
    {
        if (null === $this->focalPointDetection) {
            $this->_usedProperties['focalPointDetection'] = true;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('focal_point_detection', $value)) {
            $this->_usedProperties['focalPointDetection'] = true;
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['focalPointDetection'])) {
